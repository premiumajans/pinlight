                ...
                <div id="primary" className="content-area">
                    ...
                    <div data-aos="fade-zoom-in"
                        ...
                        <section className="section section-padding contact-background m-b-0">
                            <div className="section-container small row contact-row">
                                <div className="block block-contact-form col-md-8 col-12">
                                ...
                                <div className="block block-contact-info col-md-4 col-12 d-flex align-items-center">
                                            ...
                                            <div className="row">
                                                <div className="col-md-12 sm-m-b-30 ">
                                                    <div className="info-item my-4">
                                                        ...
                                                        <div style={{color:'black'}} className="item-content">
